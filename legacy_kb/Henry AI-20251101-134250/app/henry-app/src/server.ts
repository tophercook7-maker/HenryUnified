...
// --- static mount for built client ---
// eslint-disable-next-line @typescript-eslint/no-var-requires
app.use(express.static(path.join(process.cwd(), "client", "dist")));
/* removed invalid "*" */
//  (_req, res) => res.sendFile(path.join(process.cwd(), "client", "dist", "index.html")));

app.get(/.*/, (_req, res) => res.sendFile(path.join(process.cwd(), "client", "dist", "index.html")));
